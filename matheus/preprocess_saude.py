...
print(f"\n{green}CASOS (SELEÇÃO):\n{reset}{casos.columns}\n")
"""
XX - REVER ESSAS DATAS (ANONIMIZADAS?)
OK - REVER MUNICÍPIOS COM DÍGITO A MENOS (ANONIMIZADOS?)
CASOS:
