...
##### CAMINHOS E ARQUIVOS ########################################################
caminho_dados = "/home/sifapsc/scripts/matheus/fapesc_dengue/domenica/dados/"
nome_arquivo = "regional_saude.csv"
caminho_arquivo = f"{caminho_dados}{nome_arquivo}"
resultado = "censo_sc_regional.csv"
caminho_resultado = f"/home/sifapsc/scripts/matheus/fapesc_dengue/domenica/dados/{resultado}"
